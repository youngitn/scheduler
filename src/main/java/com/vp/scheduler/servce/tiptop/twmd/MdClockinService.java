...
import com.vp.scheduler.servce.t100.MdClockinDataIntegrationService;
import com.vp.scheduler.servce.tiptop.twvp.ClockinService;
import com.vp.scheduler.servce.tiptop.twvp.CqrFileService;

@Service
public class MdClockinService {
	@Autowired
	MdClockinDataIntegrationService service;

	@Autowired
	MdCqrFileService cqrService;

	public static MdClockinService thisClass;
