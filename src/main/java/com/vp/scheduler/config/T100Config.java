...
@EnableJpaRepositories(
		...
		entityManagerFactoryRef = "t100EntityManagerFactory", 
		transactionManagerRef = "t100TransactionManager",
		basePackages = {
		"com.vp.scheduler.dao.t100" })
public class T100Config {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(t100DataSource).packages("com.vp.scheduler.entity.t100").persistenceUnit("t100")
				.build();
	}
